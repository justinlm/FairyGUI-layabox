...
declare namespace fgui {
    class GGraph extends GObject {
        ...
        drawPolygon(lineSize: number, lineColor: string, fillColor: string, points: any[]): void;
        distances: number[];
        color: string;
        private updateGraph;
...
declare namespace fgui {
    class GRoot extends GComponent {
        ...
        private _layer3Obj;
        private _layer4Obj;
        static LAYER_1: number;
        static LAYER_2: number;
        static LAYER_3: number;
        static LAYER_4: number;
        private static _inst;
        static readonly inst: GRoot;
        constructor();
        private createLayerNode;
        private addChild1;
        AddToUI(child: GComponent, layer: number): GObject;
        DeleteUI(child: GComponent, layer: number, dispose?: boolean): GObject;
